...
export class NgTimelineComponent implements AfterViewInit, OnChanges, OnDestroy {
  ...
  @ContentChildren(NgTimelineEntryComponent)
  private content: QueryList<NgTimelineEntryComponent>;
